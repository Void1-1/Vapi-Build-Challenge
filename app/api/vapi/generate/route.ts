...
export async function POST(request: Request) {
  ...
  try {
    const { text: responseText } = await generateText({
      ...
      prompt: `
        You are F.R.I.D.A.Y., an advanced AI voice assistant modeled after an AI from the MCU created by Tony Stark. Speak in a professional but witty tone. Prioritize clear, concise responses. Respond helpfully to all commands.
